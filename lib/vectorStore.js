...
class DummyEmbeddings {
  constructor() {
    this.dimension = 1000; // For e5-mistral-7b-instruct like
  }
...
class VectorStoreManager {
  constructor() {
    this.embeddings = new DummyEmbeddings();
    this.store = null;
    this.graphData = null;
  ...
  async initVectorDB() {
    ...
    try {
      // Delete collection if Weaviate, for Chroma skip as it may not have deleteCollection
